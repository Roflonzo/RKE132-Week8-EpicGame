string folderPath = @"C:\Users\RolfK\OneDrive\Documents\data";
...
//string[] heroes = {"hulk", "the mandalorian", "anakin skywalker", "thor"};
//string[] villians = {"jabba the hut", "vladimir putin", "trump", "ork"};
//string[] weapon = { "toothpick", "battleaxe", "blaster", "lightsaber"};
